...
### Generating data
The app runs on a PostgreSQL database on Sequelize ORM. You will need to create your own database and hook it. To that end, an `envexample` file is provided within `/server`, for you to hook the private information of your database.
